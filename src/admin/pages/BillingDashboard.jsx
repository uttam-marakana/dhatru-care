...
export default function BillingDashboard() {
  ...
  const loadData = async () => {
    try {
      const [invoiceData, revenueData] = await Promise.all([getInvoices(), getRevenueStats()]);
  ...
  return (
    <div className="space-y-8">
      <AdminHeader title="Billing Dashboard" description="Manage invoices and payments" />
