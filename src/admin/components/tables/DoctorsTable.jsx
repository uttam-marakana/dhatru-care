  ...
  return (
    <div className="glass overflow-x-auto">
      <table className="min-w-full text-sm">
        ...
        <tbody>
          {doctors.map((doctor) => (
            <tr key={doctor.id} className="border-b border-[var(--border)] hover:bg-[var(--card)]">
              ...
              <td className="p-4 flex gap-3">
                <button onClick={() => onEdit(doctor)} className="text-[var(--color-primary)]">
                  Edit
                </button>

                <button onClick={() => onDelete(doctor)} className="text-[var(--color-error)]">
                  Delete
                </button>
              </td>
            </tr>
